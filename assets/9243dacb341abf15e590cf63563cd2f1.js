  ...
  (function($, window, document) {
    ...
    return Console = (function() {
      ...
      function Console($container, $options) {
        ...
        $container.html("<pre class=\"output\"></pre>\n<kbd class=\"enter\">\n<span class=\"prompt\"></span><input class=\"input\" " + $auto + " />\n</kbd>");
        this.output = $container.find('.output');
        this.prompt = $container.find('kbd .prompt');
        this.kb = $container.find('kbd .input');
